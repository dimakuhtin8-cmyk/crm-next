    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-8">
      <div className="max-w-2xl text-center space-y-6">
        ...
        <p className="text-lg text-foreground-secondary">
          CRM нового поколения для украинского бизнеса. Zero-Touch Auto-Fill,
        ...
        <div className="grid grid-cols-3 gap-4 pt-8">
          <Card className="p-4">
            ...
            <div className="text-xs text-foreground-muted mt-1">Ручного ввода</div>
          </Card>
          <Card className="p-4">
          ...
          <Card className="p-4">
            ...
            <div className="text-xs text-foreground-muted mt-1">Мессенджеры</div>
          </Card>
        </div>
      </div>
    </main>
